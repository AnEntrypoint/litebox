# litebox — archived pass-by-pass history, superseded 2026-09-05

**This file is a forensic archive, not a starting point for new work.** It is the full,
detailed, pass-by-pass log that accumulated in `AGENTS.md` between 2026-09-03 and 2026-09-05
(covering the XFCE/MATE desktop investigation, the RtlpUnwindPrologue crash investigation, the
Windows CoW-mmap performance work, input-latency fixes, and the image-fetch tooling work),
preserved here for anyone who needs the detailed reasoning trail behind a conclusion now stated
concisely in the current `AGENTS.md`. Read the current `AGENTS.md` first; come here only if you
need to see exactly how a conclusion was reached, what was tried and ruled out along the way, or
the specific evidence behind a claim.

---

# litebox — current state (2026-09-03) [ARCHIVED SNAPSHOT, DO NOT EDIT]
